...
class gCal {
	...
	function getCalendar($calname, $show = '', $tagstring = '') {
		// hack for now
		//$userid = $GLOBALS['lookup'][$calname][0];
		//$magiccookie = $GLOBALS['lookup'][$calname][1];
		$userid = 'oi64hggarb2m1jqurc86ujp1ac%40group.calendar.google.com';
//http://www.google.com/calendar/feeds/qg3cvcesu1dja30djtflp290v4%40group.calendar.google.com/private-5f7084dd127e510f43a7b2345ccfde47/basic
		$magiccookie = '41571496709beccaafbf6c339ca19650';
